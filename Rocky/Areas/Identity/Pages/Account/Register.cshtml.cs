...
namespace Rocky.Areas.Identity.Pages.Account
{
    ...
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            [Required]
            [RegularExpression(@"^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)(?=.*[\W_]).{6,}$", ErrorMessage = "The password must contain at least one lowercase letter, one uppercase letter, one digit, one symbol, and be at least 6 characters long.")]
            ...
            [RegularExpression(@"^[^a-zA-Z!@#$%^&*()_+={}|[\]\\:;'<>?,./]*$", ErrorMessage = "The phone number can only contain numeric characters.")]
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    {
                        return RedirectToPagePermanent("Identity/Account/Login");
